...
require_once __DIR__ . '/socket/BamiMessenger.php';
...
$console
    ...
    ->setCode(function (InputInterface $input, OutputInterface $output) {
        ...
        $bamiMessenger = new BamiMessenger();
        $bamiMessenger->addOrderMessage($user['first_name'], $user['last_name'], $user['image'], $amount);
...
$console
    ...
    ->setCode(function (InputInterface $input, OutputInterface $output) {
        ...
        if($orders == null){
            $output->writeln('No bami disks have been orderd today!');
            return;
        }
